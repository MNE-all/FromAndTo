...
class OrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        orderList.add(OrderDomain("Вячеслав","10:00","11:00",10000,
            "ул. Комендантский проспект, СПб","ул. Комендантский проспект, Москва",
            4.0))
        orderList.add(OrderDomain("Николай","06:00","15:00",4000,
            "ул. Комендантский проспект, Урал","ул. Комендантский проспект, Мурманск",
            4.0))
        orderList.add(OrderDomain("Дмитрий","00:00","01:00",3000,
            "ул. Комендантский проспект, Волга","ул. Комендантский проспект, Хабаровск",
            4.0))
        orderList.add(OrderDomain("Данила","04:00","08:40",14000,
